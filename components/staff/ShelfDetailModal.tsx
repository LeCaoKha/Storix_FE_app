    ...
    return (
      <View style={styles.section}>
        ...
        {items.map((item, idx) => (
          <View
            key={`${item.id}-${idx}`}
            style={[styles.itemRow, !isAuto && styles.manualItemRow]}
          >
            <View style={styles.itemInfo}>
              ...
              <View style={styles.itemMeta}>
                ...
                <Text style={styles.itemBin}>
                  Vị trí:{" "}
                  <Text style={{ fontWeight: "700" }}>{item.binCode}</Text>
                </Text>
              </View>
            </View>
            <View style={styles.itemQty}>
              <Text style={styles.qtyLabel}>
                {operationType === "inbound" ? "Cần xếp" : "Cần nhặt"}
              </Text>
      ...
      <Pressable style={styles.overlay} onPress={onClose}>
        ...
        >
          ...
          >
            ...
            {renderItemSection(
              manualOnly,
              "Vị trí trống (Xếp hàng thủ công)",
              false,
            )}
              ...
              <View style={styles.infoGrid}>
                <View style={styles.infoItem}>
                  ...
                  <Text style={styles.infoValue}>
                    {shelf.x.toFixed(1)}, {shelf.y.toFixed(1)}
                  </Text>
                </View>
                <View style={styles.infoItem}>
                  <Text style={styles.infoLabel}>Kích thước</Text>
                  <Text style={styles.infoValue}>
                    {shelf.width}x{shelf.height}
                  </Text>
                </View>
                <View style={styles.infoItem}>
                ...
                {isProcessing ? (
                  ...
                  <>
                    ...
                    <Text style={styles.operationButtonText}>
                      Xác nhận{" "}
                      {operationType === "inbound" ? "đã xếp" : "đã nhặt"}{" "}
                      {recommendedItems.length} mặt hàng
                    </Text>
                  </>
                )}
              </TouchableOpacity>
